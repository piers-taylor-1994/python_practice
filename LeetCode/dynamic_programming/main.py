...
class Solution:
    ...
    def coin_change_2(self, coins, amount):
        def dp(amount, memo):
            if amount == 0:
                return 0
            elif amount < 0:
            ...
            if amount not in memo:
                memo[amount] = min([dp(amount - c, memo) for c in coins]) + 1
            return memo[amount]
        memo = {}
        output = dp(amount, memo)
        return output if output != float('inf') else -1
    
    def coin_change_2_2(self, coins, amount):
...
print(solution.coin_change_2([1,2,5], 11))
print(solution.coin_change_2([2], 3))
print(solution.coin_change_2([1], 0))
# print(solution.coin_change_2_2([1,2,5], 11))
print(solution.coin_change_2_2([2], 3))
print(solution.coin_change_2_2([1], 0))